...
router.route("/createRoom").post(upload.array("images", 10), roomController.createRooms);
router.route("/updatedRoom").put(upload.array("images", 10), roomController.updateRoom);
